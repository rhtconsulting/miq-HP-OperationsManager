:project-name: miq-HP-OperationsManager
:project-repo: https://github.com/rhtconsulting/miq-HP-OperationsManager
:project-zip: https://github.com/rhtconsulting/miq-HP-OperationsManager/archive/master.zip
